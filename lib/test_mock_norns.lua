...
TestMockMetro = {
  ...
  test_can_start_and_run_a_metro = function()
    ...
    local c = _norns.metros[11]

    lu.assertEquals(c.is_running, false)

    _norns.metro_start(11, 0.5, 3, 1)
    lu.assertEquals(c.is_running, true)
  ...
  test_can_set_norns_time = function()
    ...
    lu.assertEquals(c.is_running, false)  -- ...and metro should stop running.
